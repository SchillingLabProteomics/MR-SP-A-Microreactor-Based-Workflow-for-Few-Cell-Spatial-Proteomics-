...
Raw data and search results are deposited separately on MassIVE (MSV000099955).
...
Raw LC–MS/MS data and search engine outputs are available on MassIVE(MSV000099955)
